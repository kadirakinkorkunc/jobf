package com.jobf.finder.common.rest.configuration;
...
@Configuration
public class Localization extends AcceptHeaderLocaleContextResolver implements WebMvcConfigurer {
    ...
    public ResourceBundleMessageSource messageSource() {
        ...
        source.setBasenames("i18n/finder");
    ...
    public LocaleContext resolveLocaleContext(ServerWebExchange exchange) {
        ...
        return new SimpleLocaleContext(Locale.of(language));
    }
